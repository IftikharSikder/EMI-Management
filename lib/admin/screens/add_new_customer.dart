...
import 'package:untitled/admin/controllers/sell_new_device_controller.dart';
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  obscureText: !controller
                                      .showPassword
                                      .value, // Toggle based on showPassword value
                                  validator: (value) {
                                    if (controller.showValidation.value &&
                                        (value == null || value.isEmpty)) {
                              ...
                              if (!controller.isExistingCustomer.value) ...[
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    onPressed:
                                        controller.isGeneratingPassword.value ||
                                            controller.passwordGenerated.value
                                        ? null
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Obx(() {
                                      final bool isSelected =
                                          controller.selectedDeviceId.value == device['id'];
                              ...
                              ? Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          const Expanded(flex: 2, child: Text('Device Name:')),
                                          Expanded(
                                            flex: 3,
                                            child: Text(
                                      ...
                                      Row(
                                        children: [
                                          const Expanded(flex: 2, child: Text('Unit Price:')),
                                          Expanded(
                                            flex: 3,
                                            child: Text(
